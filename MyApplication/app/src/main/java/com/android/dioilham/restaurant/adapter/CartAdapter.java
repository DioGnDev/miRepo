...
public class CartAdapter extends ArrayAdapter<ItemCart> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (rootView == null) {
            ...
            holder.kode = (TextView) rootView.findViewById(R.id.kode);
        ...
        holder.keterangan.setText(dataItemCart.getKetCart());
        holder.kode.setText(dataItemCart.getKodeCart());
    ...
    static class ItemCartHolder {
        ...
        TextView harga;
        TextView qty;
        TextView subtotal,keterangan, kode;
    }
}
